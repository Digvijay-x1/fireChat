...
export async function getFriendRequests(req, res) {
    try {
        const incommingRequests = await FriendRequest.find({recipient: req.user.id, status: "pending"}).populate("sender", "fullName profilePic nativeLanguage learningLanguage");
